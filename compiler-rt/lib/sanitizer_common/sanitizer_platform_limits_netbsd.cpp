...
#include <dev/fivisual/fivisual.h>
#else
#define FIvisual_SET_FD          _IOWR('S', 1, int)
#define FIvisual_SET_PID         _IOWR('S', 2, pid_t)
#endif
...
unsigned IOCTL_FIvisual_SET_FD = FIvisual_SET_FD;
unsigned IOCTL_FIvisual_SET_PID = FIvisual_SET_PID;
